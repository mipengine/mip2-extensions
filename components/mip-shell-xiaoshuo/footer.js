...
class footer {
  ...
  _createFooterDom () {
    ...
    let prevHrefString = previousHref ? `mip-link replace href="${this.config.hrefButton['previous-href']}"` : ''
    let nextHrefString = nextHref ? `mip-link replace href="${this.config.hrefButton['next-href']}"` : ''
    let footerHTML = `
